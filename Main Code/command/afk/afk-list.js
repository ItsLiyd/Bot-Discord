...
try {
  ...
  AfkUser = null; // fallback ke cache jika model tidak tersedia
}
...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('afk-list')
    .setDescription('List orang unik 😹'),
  ...
  async execute(interaction) {
    ...
    try {
      if (AfkUser) {
        ...
        const MAX_USERS = 10; // adjust sesuai kebutuhan
        ...
        // jika ada lebih banyak user, pake pagination 
